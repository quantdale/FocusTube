...
Execute the IMPLEMENTATION_V1 campaign continuously. Do not stop after one task or work packet: implement, validate, fix failures, record evidence/checkpoints, advance durable state, and continue to the next dependency-safe packet until IC-EXIT passes or a true global stop condition is recorded.
